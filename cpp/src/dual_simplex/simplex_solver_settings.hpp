 ...
 public:
  simplex_solver_settings_t()
    : iteration_limit(std::numeric_limits<i_t>::max()),
      ...
      fixed_tol(1e-10),
      zero_tol(1e-9),
      barrier_relative_feasibility_tol(1e-3),
      barrier_relative_optimality_tol(1e-3),
      barrier_relative_complementarity_tol(1e-3),
      barrier_relaxed_feasibility_tol(1e-3),
      barrier_relaxed_optimality_tol(1e-3),
      barrier_relaxed_complementarity_tol(1e-3),
      cut_off(std::numeric_limits<f_t>::infinity()),
      steepest_edge_ratio(0.5),
      steepest_edge_primal_tol(1e-6),
