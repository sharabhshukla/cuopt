...
solver_settings_t<i_t, f_t>::solver_settings_t() : pdlp_settings(), mip_settings()
{
  ...
  int_parameters = {
    ...
    {CUOPT_METHOD, reinterpret_cast<int*>(&mip_settings.root_lp_method), CUOPT_METHOD_CONCURRENT, CUOPT_METHOD_BARRIER, CUOPT_METHOD_CONCURRENT},
  ...
  bool_parameters = {
    ...
    {CUOPT_CROSSOVER, &mip_settings.root_lp_crossover, false},
