  ...
  do {                                                                                           \
    ...
    if (_status != CUDA_SUCCESS) {                                                               \
      ...
      std::cerr << "\n\nError: " << __FILE__ << ":" << __LINE__ << ": Function "                 \
                << #apiFunctionCall << " failed with error(" << _status << "): " << pErrorString \
                << ".\n\n";                                                                      \
                                                                                                 \
      exit(EXIT_FAILURE);                                                                        \
    }                                                                                            \
...
#define CHECK_CONDITION(condition)                                                              \
  do {                                                                                          \
    if (!(condition)) {                                                                         \
      std::cerr << "\n\nError: " << __FILE__ << ":" << __LINE__ << ": Condition " << #condition \
                << " failed.\n\n";                                                              \
                                                                                                \
      exit(EXIT_FAILURE);                                                                       \
    }                                                                                           \
...
#define CHECK_INTEGER_CONDITION(argument1, operator, argument2)                                                                                 \
  do {                                                                                                                                          \
    if (!(argument1 operator argument2)) {                                                                                                      \
      std::cerr                                                                                                                                 \
        << "\n\nError: " << __FILE__ << ":" << __LINE__ << ": Condition " << #argument1 << " "                                                  \
        << #                                                                                                                                    \
           operator<< " " << #argument2 << " fails. " << #argument1 << " = " << argument1 << ","                                                \
                                                                                             " " << #argument2 << " = " << argument2 << "\n\n"; \
                                                                                                                                                \
      exit(EXIT_FAILURE);                                                                                                                       \
    }                                                                                                                                           \
