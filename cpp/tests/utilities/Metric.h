                          ...
                          const uint8_t* pCounterAvailabilityImage)
{
  ...
  for (auto& metricName : metricNames) {
    ...
    RETURN_IF_NVPW_ERROR(
      false, NVPW_MetricsEvaluator_GetMetricRawDependencies(&getMetricRawDependenciesParms));
                    ...
                    const uint8_t* pCounterAvailabilityImage)
{
  ...
  if (pCounterAvailabilityImage) {
    ...
    RETURN_IF_NVPW_ERROR(
      false, NVPW_RawMetricsConfig_SetCounterAvailability(&setCounterAvailabilityParams));
  }
